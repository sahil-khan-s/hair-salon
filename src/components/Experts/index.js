 ...
 <div className='container md:max-w-container px-4 lg:px-[112px] pb-[136px] mx-auto '>
       <div className='grid md:grid-cols-2 pb-[96px]'>
           <div className='xl:pt-[139px] pt-20'>
             ...
             <p className='pt-[14px] font-[500] text-[#221F20]'>{discription}</p>
             <p className='pt-[24px]  font-[500] text-[#221F20]'> {discription2}</p>
           </div>
           <div className='flex justify-center md:justify-end pt-[96px]'>
           <img src={image} alt="" className='w-[300px] sm:w-[429px] sm:h-[363px]' />
           </div>
       </div>
       <div>
        <h1 className='text-[36px] font-[700] leading-[125%] text-center'>{subSectionTitle}</h1>
        <p className='text-[20px] text-[#221F20;] font-[400] pt-[16px] text-center max-w-[980px] mx-auto   '>{subSectionDiscrp}</p>
